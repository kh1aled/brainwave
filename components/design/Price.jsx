  ...
  return (
    <section id="Price" className="Price p-4 mt-6">
      <div className="container">
        ...
        <h2 className="text-[2.75rem] my-4 leading-[2.5rem]">
        ...
        <a href="" className="font-code text-center my-6 py-2 text-[1.1rem] font-bold tracking-wider uppercase border-b m-auto leading-[1rem] w-[15rem]">
