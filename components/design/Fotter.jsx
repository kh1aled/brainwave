  ...
  return (
    <section id="Fotter" className="Fotter p-4 mt-6 mb-4">
      <div className="container">
        <p class="text-n-4 text-center my-6 ml-auto lg:block leading-[1.25rem] text-[1.5rem]">
        ...
        <ul className="flex gap-5 flex-wrap justify-center items-center">
          <a
            href="#"
            target="_blank"
            class="flex items-center justify-center  w-16 h-16 bg-n-7  transition-colors hover:bg-n-6"
          >
